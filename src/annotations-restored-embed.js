...
// %%ANNOTATION_LIB%%: This will be replaced with AnnotationParser.js and AnnotationRenderer.js

let annotationRendererCss = `%%ANNOTATION_RENDERER_CSS%%: This will be replaced with AnnotationRenderer.css`;
